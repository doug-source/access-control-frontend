        ...
        <>
            <BtnRow
                show={
                    ...
                    abilities.includes('attach-ability-to-user')
                }
                description={`Botão para vincular ao usuário a habilidade de nome ${data.name}.`}
            ...
            <BtnRow
                show={
                    !pathname.endsWith('/attach') &&
                    abilities.includes('detach-ability-from-user')
                }
                description={`Botão para desvincular do usuário a habilidade de nome ${data.name}.`}
