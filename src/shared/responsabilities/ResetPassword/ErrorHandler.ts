...
type Output = Params['ErrorHandler']['ResetPassword']['Output'];

export class ResetPasswordErrorHandler implements ErrorHandler {
    handle(output: Output, state: ResetPasswordState): ResetPasswordState {
