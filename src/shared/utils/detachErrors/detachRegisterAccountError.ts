...
import { type RegisterAccountErrorResponse } from '@/shared/types/Response/Guest/RegisterAccount';
import { makeForbiddenErrorMsg } from '@/shared/utils/makeForbiddenErrorMsg';

export function detachRegisterAccountError(
    response: RegisterAccountErrorResponse
): ResponseErrorData {
